...
트리플-슬래시-참조-타입 지시어를 패키지 선언을 위한 `import`로 생각하면 이해하기 쉽습니다.
...
[`tsconfig.json`에서 `@types`, `typeRoots` 과 `types` 사용하기](./tsconfig.json.md#types-typeroots-and-types)에서 더 자세한 것을 확인할 수 있습니다.
